          ...
          <Reveal delay={120}>
            <Card variant="elevated" className="relative overflow-hidden p-0">
              ...
              <div className="relative grid min-h-[34rem] gap-4 p-5 sm:p-6">
                <div
                  className="grid flex-1 rounded-[1.5rem] border border-white/10 bg-[linear-gradient(180deg,rgba(15,23,42,0.18),rgba(15,23,42,0.78)),var(--spotlight-image)] bg-cover bg-center bg-[length:110%] p-6 transition-all duration-700 hover:bg-[length:115%]"
